...
public class FirstAspect {
    ...
    */
    @Pointcut("within(com.ob11to.spring.service..*)")
...
//    @Pointcut("target(org.springframework.data.repository.Repository)")
    ...
    /*
        ...
        * - any param type
        .. - 0+ any params type
     */
    @Pointcut("isControllerLayer() && @args(com.ob11to.spring.validation.UserInfo,..)")
     ...
     */
    @Pointcut("execution(public * com.ob11to.spring.service.*Service.findById(*))")
